		...
		<>
			...
			<div className='testimonial-container w-11/12 mx-auto mb-20'>
				...
				<div className='testimonial-heading text-center my-20'>
					<h1 className='flex flex-col justify-center items-center bg-cover text-black bg-center text-2xl md:text-4xl lg:text-5xl font-extrabold underline underline-offset-4 mb-5'>Our Clients Say About us</h1>
				...
				<div className='relative mx-auto py-6 px-4 w-full max-w-7xl bg-gray-100 text-gray-800'>
					<div className='mx-auto max-w-sm sm:max-w-none grid grid-cols-4 gap-5'>
						...
						<div className='col-span-full sm:col-span-2 lg:col-span-1 grid grid-rows-2 rounded-xl shadow-lg overflow-hidden bg-white'>
							...
							<div className='relative py-10 px-4 inline-flex justify-center items-center'>
								...
								<p className='z-10 relative text-center text-gray-600'>
									" All Brands are the best. I have been using them for years and they have never let me down. I would recommend them to anyone who is finding second hand cars. They are the best."
								</p>
								{/* :::quote svg */}
								<svg
						...
						{/* :CONTAINER 2 */}
						<div className='col-span-full sm:col-span-2 lg:col-span-1 py-6 pl-6 pr-2 flex flex-col rounded-xl bg-red-800 text-white'>
							{/* ::Quote SVG */}
							<div className='mb-2'>
							...
							{/* ::Testimony 2 */}
							<p className='text-lg md:text-xl lg:text-2xl font-bold leading-normal'>" Hello buyers and Sellers , I have been using this website for a long time and I have never been disappointed "</p>
							{/* ::Name */}
						...
						<div className='col-span-full lg:col-span-2 grid grid-rows-2 gap-y-5'>
							...
							<div className='row-span-1 flex rounded-xl'>
								{/* :::quote container */}
								<div className='mx-2'>
									<svg className='w-12 h-12 text-red-800' version='1.0' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 485.000000 390.000000' preserveAspectRatio='xMidYMid meet'>
								...
								<div className='flex flex-col'>
									{/* :::***testimony 3*** */}
									<p className='text-lg md:text-xl lg:text-2xl font-bold leading-normal'>
										To whom it may concern, I have been using this website for a long time and I have never been disappointed. I would recommend it to anyone who is looking for a second hand car.
									</p>
									{/* :::***name*** */}
							...
							<div className='row-span-1 relative py-4 px-6 flex flex-col justify-center rounded-xl bg-red-100'>
								...
								{/* :::testimony 3 */}
								<p className='relative text-lg md:text-xl lg:text-2xl text-red-800 font-bold leading-normal'>
									Yes!.. At last I have found a website that is easy to use and has a wide range of cars to choose from. I would recommend it to anyone who is looking for a second hand car.
								</p>
								{/* :::name */}
