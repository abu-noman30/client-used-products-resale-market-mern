								...
								<div className='w-full p-4'>
									<div className='bg-gray-100 relative rounded-lg p-8 sm:p-12 shadow-lg'>
										...
										>
											...
											<button type='submit' className='text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded text-sm w-full sm:w-auto px-5 py-2.5 text-center '>
												Submit
											</button>
										</form>
									</div>
